...
Chat.prototype.tick = function() {
  var self = this
  user_name = self.form.find('input[name=nick]').val()
  friend_name = self.form.find('input[name=friend_name]').val()


  jQuery.ajax({url: 'api/fetch', dataType: 'json', data: {since:this.last_message,'username':user_name, 'friend':friend_name},
    success: function(data) {
